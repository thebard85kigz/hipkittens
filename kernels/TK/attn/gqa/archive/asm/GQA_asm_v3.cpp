...
__global__ void __attribute__((amdgpu_num_vgpr(20))) attend_ker(const attn_globals<D> g) {
    ...
    constexpr int other_norm_reg = 20; // other norm register
